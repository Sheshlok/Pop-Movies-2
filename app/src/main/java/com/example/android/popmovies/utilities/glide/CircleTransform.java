...
/**
 * Created by sheshloksamal on 28/07/16.
 *
 *
 * See {@link "http://stackoverflow.com/a/25806229/409481"}
 *
 * To display an image with rounded corners. We can use it in our movieDetails screen to show
 * actors etc. in a movie (new section).
 */
